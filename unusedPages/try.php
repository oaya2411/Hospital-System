...
<form class="form" method="post" action="try.php" ">
...
if(isset($_POST['confirmDoc'])){
    $id = key($_POST['confirmDoc']);
    ...
    if(isset($_POST['confirm'])){
        ...
        echo $id;
        echo '<form action="try.php" method="post"><div id="confirmMessage">';
        echo 'Are You Sure You Want To Delete This?<br>';
        echo '<button type="submit" class="con" id="confirm" name="confirmDoc['.$id.']">YES</button>';
        ...
        if(isset($_POST['doc'])){
            ...
            if(sqlsrv_has_rows($result)){
                ...
                while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)){
                    ...
                    echo "<td>" . '<form method="post" action="try.php"><button type="submit" id="deleteButton" class="basket" name="confirm['.$row['doctor_id'].']"><img title="Delete" height="50px" width="50px" src="delete.png"></button></form>'. "</td>";
                    echo "</tr>";
                }
            echo "</table>";
            }else{
